...
<body class="form-v5" style="height: 100%; background: whitesmoke; ">
    <!--<center><h2 style="font-family: sans-serif; color: teal">WELCOME - CASTLEBET</h2></center>-->
		...
		<div class="form-v5-content"> 
			<div class="form-detail">
				...
				<div class="form-row-last">
					<button style="border: 1px solid whitesmoke; cursor: pointer; border-radius: 5px; width: 100%; height: 50px; background: black; color: white" name="register" class="register">SIGN IN</button>
				</div>
</div>
		</div>
	</div>
